...
{% highlight ruby %}
# if you have a controller in a namespace (in this example, "group"),
# but don't want the namespace in the
...
{% highlight ruby %}
# though, if you do your namespacing this way, you'll have both
# the name of the namespace and your arbitrary scope string in the URI
# Prefix Verb            URI Pattern                                 Controller#Action
